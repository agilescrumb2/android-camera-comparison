...
class ListKamera extends StatelessWidget {
  // Future<List<KameraList>> fetchCameraData() async {
  //   final response = await http.get(Uri.parse('https://www.cameris.my.id/api/camera'));
  //   if (response.statusCode == 200) {
  //     print(response.body);
  //     dynamic jsonBody = jsonDecode(response.body);
  //     KameraList camera = KameraList.fromJson(jsonBody);
  //     return [camera];
  //   } else {
  //     throw Exception('Failed to fetch camera data');
  //   }
  // }
  // Future fetchCameraData() async {
  //   final response = await http.get(Uri.parse('https://www.cameris.my.id/api/camera'));
  //   if (response.statusCode == 200) {
  //     Iterable it = jsonDecode(response.body);
  //     List<KameraList> camera = it.map((item) => KameraList.fromJson(item)).toList();
  //     return camera;
  //     // final List<dynamic> data = jsonDecode(response.body);
  //     // return data.map((item) => KameraList(
  //     //   nama_kamera: item['nama_kamera'],
  //     //   gambar: item['gambar'],
  //     //   harga: item['harga'],
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Expanded(
              // child: FutureBuilder<List<KameraList>>(
              //     future: fetchCameraData(),
              ...
              //                     MaterialPageRoute(
              //                       builder: (context) =>
              //                           DetailScreenBody(product: snapshot.data![index]),
              //                     ),
              //                   );
              //                 },
              //                 child: Row(
              ...
              //                           children: [
              //                             Text(
              //                               snapshot.data![index].nama_kamera ?? '',
              //                               style: TextStyle(
              ...
              //         return Text('Failed to fetch camera data');
              //       }
              //       else {
