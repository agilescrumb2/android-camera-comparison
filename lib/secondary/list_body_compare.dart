...
import 'package:android_camera_comparison/secondary/detail_compare_kamera.dart';
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  Kamera kamera = information[index];
                  return Card(
        ...
        child: Container(
          ...
          child: GestureDetector(
            ...
            onTap: (){
              Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => DetailCompareKamera(item1: selectedProducts[0], item2: selectedProducts[1]))
              );
            },
          )
        )
